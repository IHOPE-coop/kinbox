<script>
	...
	let myItems = []; // This array will hold the my needs list items
  let notifItems = []; // This array will hold the notification list items
	let kinItems = []; // This array will hold the kin's needs list items
  let ledgerItems = []; // This array will hold the ledger list items
